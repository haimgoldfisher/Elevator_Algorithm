...
public interface ElevatorAlgo {
    /**
     * @return the ex0.Building on which the (online) elevator algorithm works on.
     */
    public Building getBuilding(); // not our prob
    /**
     * @return the algorithm name - can be any String.
     */
    public String algoName(); // doesnt matter
    /**
     ...
     */
    public int allocateAnElevator(CallForElevator c); // calc the called elevator
     ...
     * @param elev the current ex0.Elevator index on which the operation is performs.
     */
