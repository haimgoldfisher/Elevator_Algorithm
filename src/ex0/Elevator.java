...
/**
 * This is the interface of a Simple ex0.Elevator in time - which has a range of floors it can visit, and has a goto and stop functionality.
 * The ex0.Elevator uses the "System" (simulated) time. e.g., for computing its current position.
 * This interface is part of Ex0 of OOP course (CS.Ariel University)
 */
public interface Elevator {
    public static final int UP = 1, LEVEL = 0, DOWN = -1, ERROR = -2;
    /** Returns the minimal floor number to which this ex0.Elevator can reach(often a negative value).
     * This is the same value as the lowest floor in the building - this elevator belongs to. */
    public int getMinFloor();
    /** Returns the maximal floor number to which this ex0.Elevator can reach.
     * This is the same value as the highest floor in the building - this elevator belongs to.  */
    public int getMaxFloor();
    /** Returns the time (in seconds it takes the ex0.Elevator to open its doors. */
    public double getTimeForOpen();
    /** Returns the time (in seconds it takes the ex0.Elevator to close its doors */
    ...
    /** Returns the ex0.Elevator's current position (floor) as an Integer. */
    public int getPos();
    ...
    /** Returns the speed (in floor per second), e.g. if the ex0.Elevator speed is 0.4 - it takes it 2.5 seconds to pass a single floor. */
