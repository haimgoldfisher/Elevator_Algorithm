...
public class Ex0_main {
    public static Long ID0 = 208936039L, ID1 = 315599563L, ID2 = null;
    public static void main(String[] ar) {
        ...
        //ElevatorAlgo ex0_alg = new ShabatElevAlgo(Simulator_A.getBuilding());  // The simplest ex0.algo ever (Shabat Elev).
        ...
        ElevatorAlgo ex0_alg = new MyElevAlgo(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
